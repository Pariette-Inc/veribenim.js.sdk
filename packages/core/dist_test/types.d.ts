 ...
 */
export type ConsentAction = 'accept_all' | 'reject_all' | 'save_preferences' | 'ping' | 'visit' | 'exit';
...
export type DsarRequestType = 'access' | 'rectification' | 'erasure' | 'restriction' | 'portability' | 'objection' | 'automated';
...
export type FieldType = 'input' | 'number' | 'email' | 'phone' | 'textarea' | 'dropdown' | 'radio' | 'checkbox' | 'file' | 'date' | 'rating' | 'divider' | 'heading';
